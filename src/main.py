...
def parse_arguments(args=None):
	...
	parser.add_argument('--model', type=str, choices=['mlp', 'wpfs', 'rf', 'fsnet', 'cae', 'dietnetworks', 'experiment1', 'experiment2', 'experiment3'], default='wpfs')
	...
	parser.add_argument('--wpn_embedding_type', type=str, default='nmf',
						choices=['histogram', 'feature_values', 'nmf', 'svd', 'raw'],
